...
public class Test2Scene extends GameScene{
    ...
    private void interactionSetup(Entity entity2) {
        ...
        dummyInteractiveComponent.mapInput(KeyCode.ENTER, () -> SystemHub.getInstance().getSystem(SceneManagementSystem.class).requestSceneChange(new Test3Scene(new BorderPane(), 1920, 1080)));
    }
